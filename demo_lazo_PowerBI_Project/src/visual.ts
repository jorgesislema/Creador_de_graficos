/**
 * Visual personalizado para Power BI - Gráfico de Lazo
...
export class Visual implements IVisual {
        ...
        this.target.innerHTML = `
            <div class="visual-container">
                <div class="chart-header">
                    <h3 class="chart-title">Gráfico de Lazo</h3>
                    <p class="chart-description">Visualización de procesos cíclicos o flujos circulares</p>
                </div>
                <div id="chartContainer" class="chart-container">
                    <div class="placeholder">
                        <div class="placeholder-icon">📊</div>
                        <h4>Visual lazo listo</h4>
    ...
    public update(options: VisualUpdateOptions) {
        ...
        if (!dataView || !dataView.categorical) {
            ...
            chartContainer.innerHTML = `
                <div class="placeholder">
                    ...
                    <p>Conecta campos de datos para generar el gráfico lazo</p>
                </div>
            `;
            return;
        }
        ...
        this.renderChart(chartContainer, chartData, "lazo");
    }
