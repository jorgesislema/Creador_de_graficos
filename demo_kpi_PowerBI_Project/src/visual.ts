/**
 * Visual personalizado para Power BI - Tarjeta KPI
...
export class Visual implements IVisual {
        ...
        this.target.innerHTML = `
            <div class="visual-container">
                <div class="chart-header">
                    <h3 class="chart-title">Tarjeta KPI</h3>
                    <p class="chart-description">Indicador clave de rendimiento</p>
                </div>
                <div id="chartContainer" class="chart-container">
                    <div class="placeholder">
                        <div class="placeholder-icon">📊</div>
                        <h4>Visual kpi listo</h4>
    ...
    public update(options: VisualUpdateOptions) {
        ...
        if (!dataView || !dataView.categorical) {
            ...
            chartContainer.innerHTML = `
                <div class="placeholder">
                    ...
                    <p>Conecta campos de datos para generar el gráfico kpi</p>
                </div>
            `;
            return;
        }
        ...
        this.renderChart(chartContainer, chartData, "kpi");
    }
